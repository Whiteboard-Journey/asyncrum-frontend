...
const useWhiteboard = () => {
    ...
    return { isCreateWhiteboardOpen, whiteboards, whiteboardLoading, whiteboardPageNumber, numberOfWhiteboards, setWhiteboards, setWhiteboardPageNumber, readAllWhiteboard, onCreateWhiteboard, onEditWhiteboard, onDeleteWhiteboard, onPageNumberClick, toggleCreateWhiteboard };
}
